...
use ziskos::zisklib::{secp256k1_fp_mul, secp256k1_fp_mul_scalar, secp256k1_fp_reduce, secp256k1_fp_negate, secp256k1_fp_add};
...
impl FieldElement4x64 {
    ...
    pub fn normalize_weak(&self) -> Self {
        Self(secp256k1_fp_reduce(&self.0))
    }
    ...
    pub fn negate(&self, _magnitude: u32) -> Self {
        Self(secp256k1_fp_negate(&self.0))
    }

    /// Returns self + rhs mod p.
    /// Sums the magnitudes.
    pub fn add(&self, rhs: &Self) -> Self {
        Self(secp256k1_fp_add(&self.0, &rhs.0))
    }

    /// Multiplies by a single-limb integer.
    /// Multiplies the magnitude by the same value.
    pub fn mul_single(&self, rhs: u32) -> Self {
        Self(secp256k1_fp_mul_scalar(&self.0, rhs as u64))
    }

    #[inline(always)]
    fn mul_inner(&self, rhs: &Self) -> Self {
        Self(secp256k1_fp_mul(&self.0, &rhs.0))
    }
